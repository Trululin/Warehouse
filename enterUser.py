...
class EnterUser(tk.Frame):
	...
	def __init__(self, parent, App):
		...
		self.text = tk.Label(self.main_frame, bg="black", text="PLEASE ENTER USERNAME AND PASSWORD BEFORE TRYING TO ADD WORKER", font=("Arial", 10, "bold"), fg="white")
		self.text.pack()
